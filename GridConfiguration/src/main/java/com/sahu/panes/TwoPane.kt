...
fun TwoPane(
    ...
    Row(modifier = modifier.fillMaxSize()) {
        ...
        if (onlyLeftPane || onlyRightPane) {
            ...
            val leftWidth =
                widthForColumns(columnSpan = leftPaneConfig.columnSpan) + gridConfiguration.horizontalMargin
            val rightWidth = gridConfiguration.layoutWidth - leftWidth

            val leftConfiguration = rememberGridConfiguration(
                layoutWidth = leftWidth,
            ...
            val rightConfiguration = rememberGridConfiguration(
                layoutWidth = rightWidth,
